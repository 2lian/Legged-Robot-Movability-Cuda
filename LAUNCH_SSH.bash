...
rsync -av --exclude-from='.gitignore' --exclude='*.bin' --exclude='image' --exclude='externals/cuda-12.2_linux' --exclude='*Cache*' --exclude='*_win' $SOURCE_DIR $DESTINATION_DIR > /dev/null
